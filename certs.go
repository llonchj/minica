/* {{{ Copyright 2015 Evan Hazlett (@ehazlett) <ejhazlett@gmail.com>
 *     Copyright 2015 Aaron Huslage (@huslage) <huslage@gmail.com>
 *     Copyright 2015 Paul Tagliamonte (@paultag) <paultag@gmail.com>
 *
